...
import { Home, Calendar, MessageSquare, Pill, LogOut } from 'lucide-react';
...
export default function PatientDashboard() {
  ...
  const links = [
    ...
    { to: '/patient/appointments', label: 'My Appointments', icon: MessageSquare },
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f8f9fa' }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', paddingBottom: '24px', borderBottom: '1px solid rgba(255,255,255,0.2)', marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '12px', opacity: 0.8, margin: '4px 0 0 0' }}>Healthcare Platform</p>
        </div>
